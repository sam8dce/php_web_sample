                       ...
                       <div class="col-xl-12">
                            <div class="row d-flex justify-content-between align-items-center">
                                <div class="header-info-left">
                                    <ul>     
                                        <li><i class="fas fa-phone"></i>+91-9312972456</li>
                    ...
                    <div class="container-fluid">
                        <div class="row align-items-center">
                            ...
                            <div class="col-xl-2 col-lg-1 col-md-1">
                                <div class="logo">
                                  <a href="index.php"><img src="assets/img/logo/xpert.png" style="width:50px;height:50px;"alt=""></a>
                                </div>
                            </div>
                ...
                <div class="row">
                    <div class="offset-xl-1 offset-lg-1 col-xl-7 col-lg-7">
                        <div class="s-detailsImg">
                            <img src="assets/img/gallery/technology_details.jpg" class='responsive' alt="" " >
                        </div>
                    </div>
                    <div class="offset-xl-1 offset-lg-1 col-xl-7 col-lg-7">
                        <div class="s-details-caption">
                            <h2>TECHNOLOGY</h2>
                            <p class="details-pera1" style="text-align:justify">The expanding Technological landscape in India has led to innovations in computer processing speeds, data storage, chip design, big data analytics, cloud computing and introduced to us the Internet of Things. These developments have radically changed sociological and behavioral patterns of millions of Indians and with it, of thousands of its businesses. This has led to rapid growth and the need to quickly find the appropriate talent for developing and securing the Technological space for unhindered and seamless delivery of its various services.</p>
                            <p class="details-pera2"style="text-align:justify">In an arena of such intense activity, finding the right candidate to fulfill the job roles at our client’s ends becomes our responsibility.</p>
                            <p class="details-pera3" style="text-align:justify">Our expertise in various Technology segments including IT products, IT services, helps us in analysing the ever-changing needs of the Technology industry and seeks the best talent for pivotal roles. We believe in driving change for both established as well as emerging Tech providers. As one of the pioneers in the recruitment industry in India, we are credited with securing placement for some of the most eminent leaders at the most respectable positions across the industry.</p>

                            <!-- btn -->
                            <a href="postresume.php" class="btn red-btn">Submit CV<i class="ti-angle-double-right"></i></a>
                        </div>
                    </div>
                </div>
            </div>
                       ...
                       <div class="single-footer-caption mb-50">
                         <div class="single-footer-caption mb-30">
                             ...
                             <div class="footer-logo">
                                 <a href="index.php"><img src="assets/img/logo/xpert.png" style="witdh:100px;height:100px;" alt="">
                             </div>
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-4 col-sm-5">
                        <div class="single-footer-caption mb-50">
                            <div class="footer-tittle">
                                ...
                                <ul>
                                 <li><a href="#">+91- 9312972456,+91-9899408786</a></li>
                                 <li><a href="#">w.anwar@xperthrs.com</a></li>
                                 <li><a href="#">S – 40, School Block, Shakarpur,
